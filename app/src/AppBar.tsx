...
function AppBar() {
  ...
  return (
    <div className={`flex flex-row items-center pl-20 border-b h-10`}>
      <button className={squareClass}><HomeIcon /></button>
      <div className={`min-w-40 max-w-52 border border-b-black px-4 text-xs flex items-center h-[41px]`}>
        <h1 className="text-bold">Current Tab</h1>
      </div>
      <button className={squareClass}><PlusIcon /></button>
