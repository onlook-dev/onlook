...
const AppBar = observer(() => {
    ...
    return (
        <div
            className={clsx(
                'flex flex-row items-center pl-20 h-10 border-b bg-background dark:bg-background-active transition-colors duration-300 ease-in-out z-50 fixed top-0 w-full',
