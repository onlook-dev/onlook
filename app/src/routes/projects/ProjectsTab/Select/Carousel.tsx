    ...
    return (
        ...
        >
            ...
            <div className="bg-secondary/20 backdrop-blur p-2 rounded-lg embla__buttons absolute left-14 top-1/2 transform -translate-y-1/2 flex flex-col gap-4 z-10 items-center">
                ...
                >
                    <ChevronUpIcon
                        className={`w-7 h-7 transition duration-300 ease-in-out ${prevBtnEnabled ? 'text-foreground' : 'text-gray-600'}`}
                    />
                </button>
                ...
                >
                    <ChevronDownIcon
                        className={`w-7 h-7 transition duration-300 ease-in-out ${nextBtnEnabled ? 'text-foreground' : 'text-gray-600'}`}
                    />
                </button>
            </div>
        </div>
