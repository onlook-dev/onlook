...
## Troubleshooting local dev setup

1. Once you start a new project, if the CodeSandbox UI does not render correctly in the Design view tab, simply switch to the Preview tab, and click the "Yes, proceed to preview" link and switch back.  The UI should render properly inside the iframe after that.
