...
Export Figma designs directly into Onlook. No developers needed. This guide shows you how to import your Figma design into Onlook.
...
2. Prompt your client to help you implement your current selection. When you submit your prompt
...
- The latest version of Figma desktop app
- Dev Mode MCP Server enabled in Figma
- An Onlook account
