...
Optional admin dashboard for managing users, subscriptions, deployments, and more.

**Best for:**
- Organizations needing internal management tools
- Teams managing multiple users and subscriptions
- Enterprise deployments requiring admin controls

[View Admin Dashboard Guide →](/self-hosting/admin-dashboard)
