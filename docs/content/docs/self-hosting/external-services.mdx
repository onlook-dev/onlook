...
These are the external services that Onlook requires:
- **[Supabase](https://supabase.com/)** - Database and authentication backend
- **Sandbox Providers**
    - We are working to add [E2B](https://github.com/e2b-dev/E2B) as a self-hosted alternative to CodeSandbox. 
    - We are also supporting a fully local version for single-machine deployments.
