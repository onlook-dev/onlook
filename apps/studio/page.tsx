...
export default function Page() {
    return (
        <div className="w-full min-h-screen flex flex-col items-center justify-center bg-white relative overflow-hidden">
            <NoiseOverlay />
            <div className="text-center text-gray-900 p-8 relative z-10">
                <h1 className="text-3xl font-semibold mb-4 tracking-tight">Hacker News Clone</h1>
                <p className="text-xl text-gray-800 mb-8">
                    Browse the latest tech news and discussions
                </p>
            </div>
        </div>
    );
