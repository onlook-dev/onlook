...
export const HotkeysArea = ({ children }: { children: ReactNode }) => {
    ...
    // Modes
    useHotkeys(Hotkey.SELECT.command, () => (
    ...
    useHotkeys(Hotkey.PAN.command, () => (
        // editorEngine.mode = EditorMode.PAN
    ));
    useHotkeys(Hotkey.PREVIEW.command, () => (
    ...
    // Copy
    useHotkeys(Hotkey.COPY.command, () => (
        // editorEngine.copy.copy()
    ));
    useHotkeys(Hotkey.PASTE.command, () => (
        // editorEngine.copy.paste()
    ));
    useHotkeys(Hotkey.CUT.command, () => (
