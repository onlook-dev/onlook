import { env } from "@/env";
import { CodeSandbox, type SandboxClient } from "@codesandbox/sdk";

const sdk = new CodeSandbox(env.CSB_API_KEY);

export async function forkBuildSandbox(sandboxId: string, userId: string, deploymentId: string): Promise<{
