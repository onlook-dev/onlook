...
import { fromDbSubscription, legacySubscriptions, prices, subscriptions, users } from '@onlook/db';
import {
            ...
            try {
                ...
                if (
                    !error
                        .toString()
                        .includes(
                            'You cannot release a subscription schedule that is currently in the `released` status.',
                        )
                ) {
                    throw error;
                }
