...
import type { CopyManager } from './copy';
import type { GroupManager } from './group';
import type { InsertManager } from './insert';
import type { MoveManager } from './move';
import type { ProjectInfoManager } from './projectinfo';
...
export class EditorEngine {
    ...
    readonly projectInfo: ProjectInfoManager;
