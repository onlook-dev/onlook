                ...
                <DialogContent className="max-w-lg">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="space-y-1 text-sm">
                                    ...
                                    <div className="flex items-start gap-2">
                                        <span className="mt-0.5">•</span>
                                        <span>
                                            Delete all of your projects from Onlook's servers.
                                        </span>
                                    </div>
                                    <div className="flex items-start gap-2">
                                        <span className="mt-0.5">•</span>
                    ...
                    <DialogFooter className="flex-col gap-3 sm:flex-row sm:gap-2">
                        ...
                        <Button
                            ...
                            className="order-1 bg-red-600 text-white hover:bg-red-700 disabled:bg-gray-300 disabled:text-gray-500 sm:order-2"
                        >
