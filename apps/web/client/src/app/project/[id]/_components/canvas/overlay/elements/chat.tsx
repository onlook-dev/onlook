...
export const OverlayChat = observer(
    ({ selectedEl, elementId, oid }: { selectedEl: ClickRectState | null; elementId: string; oid: string }) => {
        ...
        return (
            ...
            >
                <div className="flex flex-row items-center gap-2">
                    ...
                    {!inputState.isVisible && !isDevMode && (
                        <div
                            className={cn(
                                'rounded-xl backdrop-blur-lg transition-all duration-300',
                                'shadow-xl shadow-background-secondary/50',
                        ...
                        >
                            ...
                            >
                                ...
                                <span className="text-mini !font-medium whitespace-nowrap">
                                {t(transKeys.editor.panels.edit.tabs.chat.openInCode.button)}
                                </span>
                            </button>
                        </div>
                    )}
