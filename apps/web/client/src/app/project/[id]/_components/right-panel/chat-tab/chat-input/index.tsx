...
import type { ChatMessage, ChatSuggestion, ImageMessageContext } from '@onlook/models';
            ...
            >
                ...
                <div className="flex w-full flex-col p-4">
                    ...
                    <Textarea
                        ...
                        className={cn(
                            'text-small mt-2 max-h-32 resize-none overflow-auto rounded-none border-0 bg-transparent p-0 caret-[#FA003C] shadow-none focus-visible:ring-0 dark:bg-transparent',
