...
import { EditorMode, LayersPanelTabValue } from '@onlook/models';
...
export const LeftPanel = observer(() => {
    ...
    const selectedTab = editorEngine.state.layersPanelTab;

    const handleMouseEnter = (tab: LayersPanelTabValue) => {
        if (isLocked) {
            return;
        }
        editorEngine.state.layersPanelTab = tab;
    };
    ...
    const handleMouseLeave = (e: React.MouseEvent<HTMLDivElement>) => {
        if (!isLocked) {
            ...
            if (!isMouseInContentPanel(e)) {
                editorEngine.state.layersPanelTab = null;
            } else {
            ...
            editorEngine.state.layersPanelTab = selectedTab;
        }
    };
    ...
    return (
        ...
        >
            ...
            {/* Content panel */}
            {editorEngine.state.layersPanelTab && (
                <>
