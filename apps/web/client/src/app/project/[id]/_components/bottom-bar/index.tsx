    ...
    return (
        <AnimatePresence mode="wait">
            <motion.div
                ...
                className="border-border bg-background absolute bottom-4 left-1/2 flex -translate-x-1/2 flex-col overflow-hidden rounded-lg border-[0.5px] p-1 px-1 drop-shadow-xl backdrop-blur"
                transition={{
                    type: 'spring',
                    bounce: 0.1,
                    duration: 0.4,
