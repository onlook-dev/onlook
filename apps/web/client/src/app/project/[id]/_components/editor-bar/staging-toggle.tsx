    ...
    return (
        <div className="flex items-center justify-center gap-1">
            <button
                ...
                className={`flex items-center justify-center px-3 py-1.5 rounded-lg text-sm transition-all ${selectedElement === "div"
            ...
            <button
                ...
                className={`flex items-center justify-center px-3 py-1.5 rounded-lg text-sm transition-all ${selectedElement === "text"
                    ? "bg-background-tertiary/20 border border-border text-white"
                    : "text-muted-foreground border border-border/0 hover:bg-background-tertiary/20 hover:text-white hover:border hover:border-border"
                    }`}
            >
            ...
            <button
                ...
                className={`flex items-center justify-center px-3 py-1.5 rounded-lg text-sm transition-all ${selectedElement === "image"
                    ? "bg-background-tertiary/20 border border-border text-white"
                    : "text-muted-foreground border border-border/0 hover:bg-background-tertiary/20 hover:text-white hover:border hover:border-border"
                    }`}
            >
