    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <div
                        className="flex flex-row w-full items-center gap-2 bg-transparent px-3 border-b border-border py-2 text-small hover:text-foreground-hover cursor-pointer"
                    >
