...
export const SelectProject = ({ externalSearchQuery }: { externalSearchQuery?: string } = {}) => {
    ...
    return (
        ...
        >
            <div className="mx-auto w-full max-w-6xl overflow-x-visible pb-12">
                <div className="mb-12 overflow-x-visible">
                    ...
                    <div className="relative overflow-x-visible">
                        ...
                        <div
                            className="from-background pointer-events-none absolute top-0 bottom-4 left-0 z-10 w-16 bg-gradient-to-r to-transparent"
                            style={{ transform: 'translateX(-48px)' }}
                        />

                        {/* Right gradient - always visible */}
                        <div className="from-background pointer-events-none absolute top-0 right-0 bottom-4 z-10 w-16 bg-gradient-to-l to-transparent" />
