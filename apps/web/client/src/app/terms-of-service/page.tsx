            ...
            <main className="flex-1 pt-16">
                <div className="max-w-4xl mx-auto px-8 py-16">
                    ...
                    <div className="prose prose-invert max-w-none">
                        ...
                        <p className="text-foreground-secondary mb-6">
                            b. Except for contact and payment information provided for the purpose of registering for the Service, User agrees that Onlook does not wish to receive or agree to receive any personal information, financial information, protected health information or any other sensitive information regarding User or Users customers, and User agrees not to upload or transmit to Onlook any such information without the prior written consent of Onlook.
                        </p>
                        <p className="text-foreground-secondary mb-6">
