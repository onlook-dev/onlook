...
function TestimonialCard({
    ...
    const cardContent = (
        <div
            className={`bg-background-onlook border-foreground-secondary/10 flex min-h-[160px] flex-col justify-between rounded-xl border p-6 duration-200 select-none ${href ? 'hover:bg-background-onlook hover:border-foreground-secondary/20 cursor-pointer transition-colors duration-50' : ''}`}
        >
