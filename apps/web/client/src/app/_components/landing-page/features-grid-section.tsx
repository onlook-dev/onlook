    ...
    return (
        <div className="w-full max-w-6xl mx-auto py-32 px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-16 gap-y-20">
                ...
                <div>
                    <h2 className="text-foreground-secondary text-small uppercase tracking-wider mb-4">Theming &amp; Branding</h2>
                ...
                <div>
                    <h2 className="text-foreground-secondary text-small uppercase tracking-wider mb-4">React Templates</h2>
                ...
                <div>
                    <h2 className="text-foreground-secondary text-small uppercase tracking-wider mb-4">Open Source</h2>
