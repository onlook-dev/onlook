        ...
        <div className="w-full max-w-6xl mx-auto py-32 px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-16 gap-y-20">
                <div>
                    ...
                    <h2 className="text-foreground-primary text-lg md:text-xl font-light mb-6 text-balance">See AI-generated components appear in real-time</h2>
                ...
                <div>
                    ...
                    <h2 className="text-foreground-primary text-lg md:text-xl font-light mb-6 text-balance">AI automatically creates reusable components</h2>
                    <p className="text-foreground-secondary text-regular text-balance leading-relaxed">
                ...
                <div>
                    <h3 className="text-foreground-secondary text-small uppercase tracking-wider mb-4">Global Styles</h3>
                    <h2 className="text-foreground-primary text-lg md:text-xl font-light mb-6 text-balance">Define your brand colors, fonts, and spacing once</h2>
                    <p className="text-foreground-secondary text-regular text-balance leading-relaxed">
                ...
                <div>
                    <h3 className="text-foreground-secondary text-small uppercase tracking-wider mb-4">Responsive Breakpoints</h3>
                    <h2 className="text-foreground-primary text-lg md:text-xl font-light mb-6 text-balance">AI builds mobile-first components</h2>
                    <p className="text-foreground-secondary text-regular text-balance leading-relaxed">
                ...
                <div>
                    ...
                    <h2 className="text-foreground-primary text-lg md:text-xl font-light mb-6 text-balance">Navigate your app structure through an intuitive layer panel</h2>
                    <p className="text-foreground-secondary text-regular text-balance leading-relaxed">
                ...
                <div>
                    ...
                    <h2 className="text-foreground-primary text-lg md:text-xl font-light mb-6 text-balance">Start with any Next.js/Tailwind template</h2>
                    <p className="text-foreground-secondary text-regular text-balance leading-relaxed">
