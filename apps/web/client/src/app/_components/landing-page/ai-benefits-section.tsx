            ...
            <div className="space-y-24">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="flex flex-col order-2 lg:order-1">
                        <h3 className="text-foreground-secondary text-sm font-medium uppercase tracking-wider mb-4">AI Code Generation for Designers</h3>
                        <h2 className="text-foreground-primary text-2xl md:text-4xl font-light mb-6">Build Production-Ready Apps with Natural Language</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="flex flex-col order-2 lg:order-1">
                        <h3 className="text-foreground-secondary text-sm font-medium uppercase tracking-wider mb-4">Visual AI Design Tools</h3>
                        <h2 className="text-foreground-primary text-2xl md:text-4xl font-light mb-6">Collaborate with AI on a Visual Canvas</h2>
                        <p className="text-foreground-secondary text-regular mb-8 text-balance max-w-xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="flex flex-col order-2 lg:order-1">
                        <h3 className="text-foreground-secondary text-sm font-medium uppercase tracking-wider mb-4">AI Design System Management</h3>
                        <h2 className="text-foreground-primary text-2xl md:text-4xl font-light mb-6">Maintain Design System Consistency</h2>
