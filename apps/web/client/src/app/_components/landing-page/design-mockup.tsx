  ...
  return (
    <div className="break-inside-avoid mb-2">
      <div className="relative w-full">
        <div className="bg-gray-800 rounded-xs mb-1 absolute inset-0"></div>
        <img 
          src={src}
          alt={alt}
      ...
      <p className="text-[7px] text-gray-300 leading-tight font-mono uppercase mb-3">{caption}</p>
    </div>
  );
}
...
export function DesignMockup() {
  return (
    <div className="bg-gray-900 w-140 h-140 rounded-sm flex flex-col overflow-hidden">
      {/* Top Navigation Bar */}
      ...
      <div className="flex-1 flex h-full">
        {/* Left Sidebar */}
        <div className="w-9 flex flex-col items-center py-3 h-full justify-between">
