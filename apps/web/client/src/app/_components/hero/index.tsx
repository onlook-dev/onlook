...
function ButtonLink({ href, children, rightIcon }: { href: string; children: React.ReactNode; rightIcon?: React.ReactNode }) {
    return (
        <a
            href={href}
            className="text-white text-lg font-normal flex items-center gap-2 border-b border-white/80 pb-1 hover:opacity-80 transition-opacity"
        ...
        <div className="w-full h-full items-center justify-center">
            ...
            <div className="relative w-full flex items-center justify-center py-32 mt-8 overflow-hidden">
                ...
                <div className="w-full max-w-6xl mx-auto relative z-10 flex flex-col items-center justify-center bg-background-onlook rounded-3xl px-12 py-32 shadow-xl overflow-hidden md:[--md-scale:1] [--md-scale:0]" style={{ minWidth: 420 }}>
                    ...
                    `}</style>
                    <h2 className="text-foreground-primary text-3xl md:text-4xl font-light text-center mb-2">Supported by You &<br />9,412 other contributors</h2>
            ...
            <div className="w-full max-w-6xl mx-auto py-32 px-8 flex flex-col md:flex-row items-start gap-24 md:gap-12">
                <div className="flex-1 flex flex-col items-start">
                    <h2 className="text-white text-[5vw] leading-[1.1] font-light mb-8 max-w-3xl">
                        What did<br />we miss?
                    </h2>
