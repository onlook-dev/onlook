...
const meta = {
  ...
  argTypes: {
    ...
    searchQuery: {
      description: 'Search query to highlight in the project name',
      control: 'text',
    },
  },
  args: {
...
/**
 * Project card without click handler (no edit button on hover)
 */
  ...
  render: () => (
    <div className="grid grid-cols-2 gap-4">
      <SquareProjectCardPresentation
        project={createMockProject({ name: 'Dashboard' })}
        imageUrl="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80"
        HighlightText={HighlightText}
        onClick={fn()}
      />
      <SquareProjectCardPresentation
        project={createMockProject({ name: 'Portfolio' })}
        imageUrl="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?w=800&q=80"
        HighlightText={HighlightText}
        onClick={fn()}
      />
      ...
      />
      <SquareProjectCardPresentation
        project={createMockProject({ name: 'Mobile App' })}
