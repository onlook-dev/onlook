...
- Context priority and filtering
- Cross-context relationships and dependencies
...
1. **Week 1**: Base architecture and file/highlight contexts
2. **Week 2**: Error, branch, and image contexts  
3. **Week 3**: Agent rule context and simple mapping integration
4. **Week 4**: `ChatContext` integration and testing
5. **Week 5**: Migration of `provider.ts` and cleanup of deprecated code