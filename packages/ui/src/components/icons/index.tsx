...
export const Icons = {
    ...
    FigmaLogo: ({ className, ...props }: IconProps) => (
        <svg
            width="18"
            height="18"
            viewBox="0 0 24 24"
