...
- **Interact Mode:** Users can interact with their live website within the window on the canvas. This is a real preview of how the app will look and feel to the end users. If necessary, Interact Mode is an efficient 
...
### Style Panel
- **Styles Panel:** Located on the right side of the application, this Figma-like panel allows users to adjust styles and design elements seamlessly.
